...
const WhatsAppButton = () => {
  ...
  const handleClick = () => {
    const url = `https://wa.me/212708270207?text=Bonjour%2C%20puis-je%20avoir%20plus%20d%27information`;
...
const styles = {
    iconWrapper: {
      ...
      bottom: '20px',
      right: '20px',
      width: '80px',                // Increased the width for better visibility
      height: '80px',               // Increased the height for better visibility
      borderRadius: '50%',
      overflow: 'hidden',
